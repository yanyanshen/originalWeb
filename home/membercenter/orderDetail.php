...
$sql="select buyNum,goodsName,pic,price,gid,(buyNum*price) as totalPrice from home_orderGoods_shop as og,goods_shop as g
 where  og.gid=g.id and oid={$oid}";

$goodsInfo=selectMul($sql);
...
<div class="buyerbox box">
    ...
    <div class="orderprocon">
        ...
        <div class="ordersumer" id="buy">
            商品总价:￥20 + 运费:￥10 = 实付款<span style="color:red;font-size:20px;"><?=$orderInfo['orderPrice']?></span><a href="submitSuccess.php?oid=<?=$oid?>" class="tobuy">提交定单</a>
        </div>
